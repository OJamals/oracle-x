...
def get_config_value(
    key: str, default: Any = None, config_file: Optional[str] = None
) -> Any:
...
def execute_sql_query(
    db_path: str, query: str, params: Optional[tuple] = None
) -> List[Dict[str, Any]]:
...
def execute_sql_command(
    db_path: str, command: str, params: Optional[tuple] = None
) -> int:
