    ...
    try:
        ...
        if init_error:
            ...
            for i, rec in enumerate(mock_recommendations, 1):
                ...
                print(
                    f'   📈 Opportunity Score: {rec["scores"]["opportunity"]:.1f}/100'
                )
