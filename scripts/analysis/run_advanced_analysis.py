...
def main():
    ...
    print('Pipeline initialized with relaxed criteria for maximum opportunity detection')
        ...
        try:
            ...
            if recommendations:
                ...
                for i, rec in enumerate(recommendations[:2], 1):
                    print(f'  {i}. {rec.contract.option_type.value.upper()} ${rec.contract.strike:.0f} '
                ...
                if options:
                    # Show sample option
                    opt = options[0]
                    print(f'  Sample option: {opt.option_type.value.upper()} ${opt.strike} '
    ...
    print('4. The ML models are ready and will provide predictions when data is available')
