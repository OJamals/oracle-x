            ...
            return [
                {
                    ...
                    "focus": "Financial news and stock analysis",
                },
                {
                    "name": "CNBC Business",
                    "url": "https://www.cnbc.com/id/10001147/device/rss/rss.html",
                    "focus": "Business news (replaced CNN Business)",
                },
                {
                    "name": "Financial Times",
                    "url": "https://www.ft.com/rss/home",
                    "focus": "International business and markets",
                },
                {
                    "name": "Fortune",
                    "url": "https://fortune.com/feed/fortune-feeds/?id=3230629",
                    "focus": "Business insights and market analysis",
                },
                {
                    "name": "MarketWatch",
                    "url": "https://feeds.marketwatch.com/marketwatch/topstories/",
                    "focus": "Market news and financial data",
                },
                {
                    "name": "Seeking Alpha",
                    "url": "https://seekingalpha.com/feed.xml",
                    "focus": "Investment research and analysis",
                },
            ]

        def test_integration(
            self, symbols: List[str] = ["AAPL", "TSLA", "MSFT", "GOOGL"]
        ) -> Dict:
            ...
            if successful > 0:
                avg_sentiment = (
                    sum(r["sentiment_score"] for r in results.values()) / successful
                )
