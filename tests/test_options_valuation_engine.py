...
class TestOptionContract(unittest.TestCase):
    ...
    def test_market_price_calculation(self):
        ...
        # Test with no prices
        contract = OptionContract(
            symbol="AAPL", strike=150.0, expiry=self.expiry, option_type=OptionType.CALL
        )
...
class TestMonteCarloModel(unittest.TestCase):
    ...
    def test_call_pricing(self):
        ...
        price, std_error = self.model.price(
            S=100, K=100, r=0.05, q=0.02, sigma=0.25, T=1.0, option_type=OptionType.CALL
        )
        self.assertGreater(price, 0)
    ...
    def test_put_pricing(self):
        ...
        price, std_error = self.model.price(
            S=100, K=110, r=0.05, q=0.02, sigma=0.25, T=1.0, option_type=OptionType.PUT
        )
        self.assertGreater(price, 0)
    ...
    def test_expired_option(self):
        """Test pricing of expired option"""
        price, std_error = self.model.price(
            S=110, K=100, r=0.05, q=0.02, sigma=0.25, T=0, option_type=OptionType.CALL
        )
        self.assertEqual(price, 10)
...
class TestOptionsValuationEngine(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.engine = OptionsValuationEngine(
            risk_free_rate=0.05, cache_ttl=60, confidence_threshold=0.7, max_workers=2
        )
    ...
    def test_calculate_fair_value(self):
        ...
        fair_value, model_prices = self.engine.calculate_fair_value(
            self.contract, underlying_price=155.0, volatility=0.25, dividend_yield=0.02
        )
    ...
    def test_caching(self):
        ...
        fair_value1, _ = self.engine.calculate_fair_value(
            self.contract, underlying_price=155.0, volatility=0.25, use_cache=True
        )
    ...
    def test_detect_mispricing(self):
        ...
        market_data = pd.DataFrame({"Close": np.random.normal(155, 5, 100)})

        result = self.engine.detect_mispricing(
            self.contract, underlying_price=155.0, market_data=market_data
        )
    ...
    def test_undervalued_detection(self):
        ...
        result = self.engine.detect_mispricing(contract, underlying_price=155.0)
    ...
    def test_analyze_iv_surface(self):
        ...
        surface_points = self.engine.analyze_iv_surface(
            options_chain, underlying_price=155.0
        )
    ...
    def test_calculate_expected_returns(self):
        ...
        expected_return, prob_profit = self.engine.calculate_expected_returns(
            valuation, target_price=160.0, probability_model="normal"
        )
    ...
    def test_confidence_score_calculation(self):
        ...
        model_prices = {"black_scholes": 5.0, "binomial": 5.2, "monte_carlo": 4.8}
        ...
        confidence = self.engine._calculate_confidence_score(
            liquid_contract, model_prices, market_price=5.0
        )
        ...
        confidence = self.engine._calculate_confidence_score(
            illiquid_contract, model_prices, market_price=5.5
        )
...
class TestFactoryFunctions(unittest.TestCase):
    ...
    def test_analyze_options_chain(self):
        ...
        opportunities = analyze_options_chain(
            engine, symbol="AAPL", options_data=options_data, underlying_price=155.0
        )
...
class TestIntegration(unittest.TestCase):
    ...
    def test_end_to_end_valuation(self):
        ...
        # Create engine
        engine = create_valuation_engine({"risk_free_rate": 0.04, "cache_ttl": 300})
        ...
        # Create market data
        market_data = pd.DataFrame({"Close": np.random.normal(455, 10, 60)})
    ...
    def test_batch_processing_performance(self):
        ...
        opportunities = engine.scan_opportunities(
            options_chain, underlying_price=155.0, min_opportunity_score=0
        )
    ...
    def test_error_handling(self, mock_logger):
        ...
        opportunities = analyze_options_chain(
            engine, symbol="AAPL", options_data=bad_options_data, underlying_price=155.0
        )
...
class TestModelValidation(unittest.TestCase):
    ...
    def test_black_scholes_put_call_parity(self):
        ...
        call_price = engine._price_black_scholes(S, K, r, 0, sigma, T, OptionType.CALL)
        put_price = engine._price_black_scholes(S, K, r, 0, sigma, T, OptionType.PUT)
