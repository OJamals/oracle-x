...
class TestFMPAdapter(unittest.TestCase):
    ...
    @unittest.skipIf(
        not os.getenv("FINANCIALMODELINGPREP_API_KEY"), "FMP API key not available"
    )
    def test_get_quote(self):
...
def run_comprehensive_tests():
    ...
    for test_class in test_classes:
        ...
        print(
            f"  Tests: {tests_run}, Passed: {passed}, Failed: {failures + errors}, Skipped: {skipped}"
        )
