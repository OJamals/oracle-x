...
def test_integrated_feeds():
    ...
    try:
        ...
        print(f"   ✓ Options Flow: {len(options_flow.get('unusual_sweeps', []))} sweeps")
    ...
    try:
        ...
        if premium.finnhub_available or premium.fmp_available:
            ...
            if finnhub_data.get('available'):
                ...
                print(f"   ✓ Finnhub: {insider} insider, {recos} recommendations, {targets} price targets")
            ...
            if fmp_data.get('available'):
                ...
                print(f"   ✓ FMP: {estimates} analyst estimates, {institutional} institutional data, {dcf} DCF valuations")
            ...
            print("   💡 Set FINNHUB_API_KEY and FINANCIALMODELINGPREP_API_KEY to enable")
            elapsed_premium = 0
