...
class BaseNewsAdapter:
    ...
    def __init__(self, source_name: str, rss_url: str = None, api_url: str = None, api_key: str = None):
        warnings.warn(
    ...
    def get_health_status(self):
        ...
        warnings.warn("get_health_status is deprecated. Use NewsAdapter.health()", DeprecationWarning)
