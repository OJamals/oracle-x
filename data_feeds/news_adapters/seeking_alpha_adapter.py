...
class SeekingAlphaAdapter(BaseNewsAdapter):
    ...
    def __init__(self):
        ...
        super().__init__(
            source_name="seeking_alpha", rss_url="https://seekingalpha.com/feed.xml"
        )
    ...
    def fetch_news_articles(self, symbol: str, limit: int = 20) -> List[Dict[str, Any]]:
        ...
        logger.info(
            f"Filtered {len(filtered_articles)} financial articles from {len(articles)} Seeking Alpha articles for {symbol}"
        )
